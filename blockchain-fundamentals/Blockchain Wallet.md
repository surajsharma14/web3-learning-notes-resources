...
Let's return to our example. Alice and Bob agree that the $5 debt will be paid in digital tokens. To complete the transaction, Alice needs only one piece of information from Bob: his wallet address.

The process is straightforward:

1. Alice asks Bob for his wallet address.
2. Bob provides his address (e.g., `0x5328ef2...`).
